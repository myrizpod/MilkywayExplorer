...
public enum Tech {
    AUTOMATISATION_ESSENTIALS("Essentiels de l'automatisation", Material.GRAY_CARPET, null, new Tuple<>(Ressource.IRON, 0)),
    ...
    ADVANCED_CRAFTNG("Crafting Avancé", Material.CRAFTER, COMPLEX_CRAFTING, new Tuple<>(Ressource.IRON, 10), new Tuple<>(Ressource.COPPER, 10), new Tuple<>(Ressource.COPPER, 10));
